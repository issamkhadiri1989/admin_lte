 ...
 */
final class Version20231021084434 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE author (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(60) NOT NULL, birth_date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', death_date DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', bio LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, title VARCHAR(100) NOT NULL, ean13 VARCHAR(13) NOT NULL, publish_date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', edition VARCHAR(255) NOT NULL, pages INT NOT NULL, INDEX IDX_CBE5A331F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
