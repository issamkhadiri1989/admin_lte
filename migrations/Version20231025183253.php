 ...
 */
final class Version20231025183253 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, title VARCHAR(100) NOT NULL, ean13 VARCHAR(13) NOT NULL, publish_date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', edition VARCHAR(255) NOT NULL, pages INT NOT NULL, UNIQUE INDEX UNIQ_CBE5A3312FAE1FC8 (ean13), INDEX IDX_CBE5A331F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
