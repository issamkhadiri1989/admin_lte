...
final class BookFactory extends ModelFactory
{
    ...
    protected function getDefaults(): array
    {
        return [
            ...
            'pages' => self::faker()->numberBetween(10, 999),
            'price' => self::faker()->randomFloat(2, 30, 200),
            'publishDate' => \DateTimeImmutable::createFromMutable(self::faker()->dateTimeThisCentury('-10 years')),
            'title' => self::faker()->text(\rand(10, 30)),
        ];
    }
